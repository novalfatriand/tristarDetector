            ...
            <div id="indicators-carousel" class="relative w-full md:w-[90rem] md:h-[30rem] columns-md rounded-xl mt-5 md:-mt-6 md:flex md:flex-col" data-carousel="static">
                ...
                <div class="relative h-56 overflow-hidden rounded-lg md:h-full">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                        <img src="assets/img/product-image-one-1.png" class="absolute block h-auto max-w-full rounded-lg -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Product Image One">
                    </div>
                    <!-- Image 2 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="assets/img/product-image-two-2.png" class="absolute block h-auto max-w-full rounded-lg -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Product Image Two">
                    </div>
                    <!-- Image 3 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
            ...
            <div class="w-full md:w-[100rem] md:min-h-96 md:ml-1 mt-7 md:mt-5 md:px-5 font-poppins columns-md">
                ...
                <button type="button" class="text-white bg-blue-400 font-light rounded-xl rounded-tr-none rounded-bl-none text-xs px-4 py-1 me-2 mb-0 md:mb-2 mt-1 md:mt-2">BRAND NEW</button>
                    <div class="flex flex-row -mt-5 md:-mt-0">
                        ...
                        <button id="button-spec" class="mr-6 text-black font-semibold mt-10 mb-2" onclick="buttonSpec()">
                            <h5 class="text-xs md:text-base">SPEC</h5>
                        </button>
                        <button id="button-payment" class="text-black font-semibold mt-10 mb-2" onclick="buttonPayment()">
                            <h5 class="text-xs md:text-base">PAYMENT METHOD</h5>
                        </button>
                    </div>

                    <div id="text-description" class="text-sm mb-3 mt-2 font-normal text-gray-700 px-5">
                        <p id="text-standby"></p>
                    </div>
            </div>
